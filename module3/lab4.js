...
class Figure {
  ...
  deleteAll() {
    this.elements.points = this.elements.points.splice(
      this.elements.points.length - 1,
      this.elements.points.length - 2,
    );
    this.elements.lines = this.elements.lines.splice(
      this.elements.lines.length - 1,
      this.elements.lines.length - 2,
    );
  }
}
